    ...
    <div className="w-full flex flex-col justify-center min-h-fit">
      ...
      >
        <motion.div
          ...
          className="text-3xl font-bold uppercase tracking-tighter text-foreground flex items-center gap-2 font-heading"
        >
          <Filecoin />
            ...
            >
              <motion.div variants={itemVariants} className="flex mb-6">
                <motion.button
                  ...
                  className={`flex-1 py-2 px-4 text-center border-b-2 transition-colors font-heading ${
