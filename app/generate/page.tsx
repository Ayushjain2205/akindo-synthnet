          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex justify-between mt-8">
                ...
                <Button onClick={() => setStep(3)} disabled={!request.model}>
                  Next Step <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    value={request.size}
                    onChange={(e) =>
                      setRequest({ ...request, size: parseInt(e.target.value) })
                    }
              ...
              <div className="flex justify-between mt-8">
                ...
                <Button onClick={generateDataset} disabled={!request.prompt}>
                ...
                <div className="flex flex-col items-center justify-center py-20">
                  <div className="relative mb-8">
                    <div className="w-20 h-20 bg-gradient-to-br from-teal-500 to-purple-500 rounded-2xl flex items-center justify-center text-3xl animate-pulse">
                      {datasetTypes.find((t) => t.type === request.type)?.icon}
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-teal-50 border border-green-200 rounded-xl p-8 text-center">
                  ...
                  <div className="bg-white/60 rounded-lg p-4 mb-6 max-w-sm mx-auto">
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        <span>Size:</span>
                        <span className="font-medium">{request.size} rows</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Type:</span>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setListingData({ ...listingData, tags: e.target.value })
                      }
                    ...
                    {listingData.listOnMarketplace && (
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Recommended: 1-10 FIL for small datasets
                        </p>
                      </div>
                    )}
                  </div>
